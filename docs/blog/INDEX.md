...
Internal reference for authors. Not rendered on the site.

## Published Posts

| # | Slug | Title | Category | Target Keywords | Reading Time |
|---|------|-------|----------|-----------------|--------------|
| 001 | what-is-forecasting | What Is Forecasting? | fundamentals | forecasting basics, what is forecasting, time series explained | 8 min |
...
```
001 What is forecasting?          (concept)
 ↓
002 How to evaluate forecasts     (measurement)
 ↓
003 Which library to use          (tool selection)
 ↓
...
- Blog post links: `/vectrix/blog/<kebab-slug>`
- Tutorial links: `/vectrix/docs/tutorials/<slug>/`
- SVG assets: `/vectrix/blog/assets/<name>.svg`
- Installation: `/vectrix/docs/getting-started/installation/`

## SVG Convention

- Source: `docs/blog/assets/`
- SvelteKit static copy: `landing/static/blog/assets/`
- See `docs/blog/assets/README.md` for details on why this dual-location setup exists
