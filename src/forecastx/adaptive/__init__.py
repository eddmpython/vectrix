...
Usage:
    >>> from forecastx.adaptive import RegimeDetector, RegimeAwareForecaster
    ...
    >>> from forecastx.adaptive import SelfHealingForecast
    ...
    >>> from forecastx.adaptive import ForecastDNA
    >>> dna = ForecastDNA()
