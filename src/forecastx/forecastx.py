"""
ForecastX: Pure self-implemented time series forecasting engine.
...
class ForecastX:
    """
    ForecastX: Zero-config time series forecasting engine.
    ...
    def __init__(
        ...
        if verbose:
            ...
            print(f"[ForecastX v{self.VERSION}] {numbaStatus}")
